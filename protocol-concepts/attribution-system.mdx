...
4. A portion of rewards and fees are distributed among participants and the transaction event log is stored publicly onchain where anyone can verify, audit and analyze.  [View Boost Protocol’s official Dune Dashboard](https://dune.com/boost_xyz/quest-protocol-dashboard) as an example of the type of data that can be measured and analyzed.
