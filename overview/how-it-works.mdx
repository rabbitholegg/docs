...
[//]: # (TODO: update link)
There are several different ways to interact with the protocol depending on [your role](https://docs.boost.xyz/boost-protocol/overview/introduction/overview#key-contributors) in the ecosystem. To understand how it works, it’s important to get familiar with the core components that make up the Boost stack:
...
Read more about each of the above core components:
<CardGroup cols={4}>
    <Card
