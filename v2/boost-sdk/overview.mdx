...
The *Boost SDK* is a modern Typescript library for the browser and Node.js that simplifies interacting with the [Boost V2 Protocol](https://github.com/rabbitholegg/boost-protocol/blob/main), making creating and interacting with Boosts a breeze.
