...
In order to deploy boosts from a budget, the budget must be funded with enough ERC-20 tokens to cover the incentivecost of the boost plus any fees.
...
<CardGroup cols={3}>
  ...
  <Card
    title="Typedoc"
    icon="file-lines"
    href="https://boost-protocol.vercel.app/classes/ManagedBudget.html"
  >
