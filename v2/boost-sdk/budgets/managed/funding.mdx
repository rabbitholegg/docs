...
ManagedBudget is designed to hold and distribute assets that can be used to deploy boosts. The Boost SDK provides several methods to manage and view the available funds in a budget.
...
<ParamField path="transfer" type={<a href="https://boost-protocol.vercel.app/interfaces/FungibleTransferPayload.html">FungibleTransferPayload</a>} required>
