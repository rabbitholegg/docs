...
If you don't have one, you can deploy one using the [SDK](/v2/boost-sdk/budgets/managed/overview.mdx), or by following 
the [Budget Accounts guide](/v2/documentation/how-it-works/budget-accounts.mdx) to deploy one through the Boost V2 interface.
