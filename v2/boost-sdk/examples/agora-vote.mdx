...
const eventActionStepOne: ActionStep = {
  ...
  actionParameter: {
    ...
    fieldIndex: 1,
    filterData: pad(toHex(BigInt('54194543592303757979358957212312678549449891089859364558242427871997305750980'))), // We'll validate by comparing VoteCast events with a proposalId that equals the this field
  },
};
...
const eventActionStepTwo: ActionStep = {
  ...
  actionParameter: {
    ...
    fieldIndex: 2,
    filterData: pad(toHex(1n)), // We'll validate by comparing VoteCast events with a support value that equals the this field
  },
};
