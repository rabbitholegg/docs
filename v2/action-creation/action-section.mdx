...
description: "Learn how to interpret and use the main transaction details for your boost action"
---

# Action Section

The Action Section contains the main details of the transaction. Here's what you need to know:
...
Understanding these elements will help you set up the basic structure of your boost action.
