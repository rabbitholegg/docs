...
import ClaimFlow from '/snippets/claim-flow.mdx';

<Frame caption="High Level Overview of Boost V2">
   <img src="/assets/diagrams/protocol-deploy-claim.png" alt="Boost Overview Diagram" />
</Frame>
...
<Frame>
   <img src="/assets/diagrams/protocol-signing.png" alt="Boost Signature Flow" />
</Frame>
...
1. [Deploying Boosts](/v2/documentation/how-it-works/deploying-boosts)
   Learn how to set up and deploy new Boost incentive programs.

2. [Claiming Rewards](/v2/documentation/how-it-works/claiming-rewards)
   Explore the user journey for interacting with a Boost and claiming earned rewards.

3. [Use Cases](/v2/documentation/how-it-works/use-cases)
